...
export default async function GreetingPage() {
    ...
    const body = getVal('body', '高齢化が進む現代において、命を救うための心肺蘇生や一次救命処置の重要性はますます高まっています。\n\n我々「関東蘇生アカデミー」は、地域の皆様や医療スタッフに対して、最新かつ正確な知識を提供し、いざという時にためらわずに行動できる人材を育成することを使命として活動しております。\n\n尊い命を一つでも多く救うため、引き続きご支援とご協力を賜りますようお願い申し上げます。')
